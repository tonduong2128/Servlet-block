				...
				<div class="col-xs-12">
					...
					<div class="alert alert-block alert-success">
						...
						<i class="ace-icon fa fa-check green"></i> Welcome to <strong
							class="green"> Ace <small>(v1.4)</small>
						</strong>, лёгкий, многофункциональный и простой в использовании шаблон для
						админки на bootstrap 3.3.6. Загрузить исходники с <a
											...
											<div id="task-tab" class="tab-pane active">
												...
												<ul id="tasks" class="item-list">
													...
													<li class="item-default clearfix"><label
														class="inline"> <input type="checkbox" class="ace" />
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Alexa Doe's avatar"
																src="<c:url value="/common/template/admin"/>/images/avatars/avatar1.png" />
														</div>
