...
<link rel="stylesheet"
	href="<c:url value="/common/template/admin"/>/css/bootstrap.min.css" />
<link rel="stylesheet"
	href="<c:url value="/common/template/admin"/>/font-awesome/4.5.0/css/font-awesome.min.css" />

<!-- page specific plugin styles -->

<!-- text fonts -->
<link rel="stylesheet"
	href="<c:url value="/common/template/admin"/>/css/fonts.googleapis.com.css" />

<!-- ace styles -->
<link rel="stylesheet"
	href="<c:url value="/common/template/admin"/>/css/ace.min.css"
	class="ace-main-stylesheet" id="main-ace-style" />

<!--[if lte IE 9]>
			<link rel="stylesheet" href="<c:url value="/common/template/admin"/>/css/ace-part2.min.css" class="ace-main-stylesheet" />
		<![endif]-->
<link rel="stylesheet"
	href="<c:url value="/common/template/admin"/>/css/ace-skins.min.css" />
<link rel="stylesheet"
	href="<c:url value="/common/template/admin"/>/css/ace-rtl.min.css" />

<!--[if lte IE 9]>
		  <link rel="stylesheet" href="<c:url value="/common/template/admin"/>/css/ace-ie.min.css" />
		<![endif]-->
				...
				<ul class="nav ace-nav">
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar">
									<li><a href="#" class="clearfix"> <img
											src="<c:url value="/common/template/admin"/>/images/avatars/avatar.png"
									...
									<li><a href="#" class="clearfix"> <img
											src="<c:url value="/common/template/admin"/>/images/avatars/avatar3.png"
									...
									<li><a href="#" class="clearfix"> <img
											src="<c:url value="/common/template/admin"/>/images/avatars/avatar4.png"
									...
									<li><a href="#" class="clearfix"> <img
											src="<c:url value="/common/template/admin"/>/images/avatars/avatar2.png"
									...
									<li><a href="#" class="clearfix"> <img
											src="<c:url value="/common/template/admin"/>/images/avatars/avatar5.png"
					...
					<li class="light-blue dropdown-modal"><a
						data-toggle="dropdown" href="#" class="dropdown-toggle"> <img
							...
							src="<c:url value="/common/template/admin"/>/images/avatars/user.jpg"
